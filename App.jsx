...
export default function App() {
  ...
  const COLORS = ["#0088FE", "#00C49F", "#FFBB28", "#FF8042", "#A28BFE", "#FF6699", "#8884d8"];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-100 to-pink-100 flex flex-col">
      ...
      <header className="text-center py-8">
        ...
        <p className="text-sm text-gray-600 mt-2">Upload food image to analyze its nutrients</p>
      </header>
              ...
              return (
                <div key={index}>
                  <h2 className="text-xl font-semibold text-center mb-4">
                    🍽 Nutrition Info for <span className="text-blue-600 font-bold">{food}</span>
                  </h2>
